...
namespace InventoryManagement.Infrastructure.Migrations
{
    ...
    [Migration("20230220150029_ProductsToInventories")]
    partial class ProductsToInventories
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InventoryProduct", b =>
                {
                    b.HasOne("InventoryManagement.Core.Entities.Inventory", null)
                        .WithMany()
                        .HasForeignKey("InventoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InventoryManagement.Core.Entities.Product", null)
                        .WithMany()
